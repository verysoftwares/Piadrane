...
function love.load()
    ...
    ex_quad2=love.graphics.newQuad(6*16,3*16,16,16)
    ex_quad3=love.graphics.newQuad(3*16,2*16,16,16)
    ex_quad4=love.graphics.newQuad(2*16,2*16,16,16)
    ex_quad5=love.graphics.newQuad(3*16,5*16,16,16)
    ...
    co_quad3=love.graphics.newQuad(8*16,5*16,16,16)
